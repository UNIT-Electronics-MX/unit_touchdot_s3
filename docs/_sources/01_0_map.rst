...
.. only:: latex
    ...
    .. figure::  ./_static/pinout/unit_pinout_top_v_0_2_0_ue0072_touch_dot_s3_en.png
        :align: center

        Top View Pinout Touch Dot S3
      
    .. figure::  ./_static/pinout/unit_pinout_bottom_v_0_2_0_ue0072_touch_dot_s3_en.png
        :align: center

        Bottom View Pinout Touch Dot S3
...
.. only:: html
   ...
   .. raw:: html
      ...
      <div style="text-align: center;">
        <a href="./_static/pinout/unit_pinout_top_v_0_2_0_ue0072_touch_dot_s3_en.png" target="_blank">
          <img 
            src="./_static/pinout/unit_pinout_top_v_0_2_0_ue0072_touch_dot_s3_en.png" 
            alt="Top View Pinout Touch Dot S3" 
      ...
      <div style="text-align: center;">
        <a href="./_static/pinout/unit_pinout_bottom_v_0_2_0_ue0072_touch_dot_s3_en.png" target="_blank">
          <img 
            src="./_static/pinout/unit_pinout_bottom_v_0_2_0_ue0072_touch_dot_s3_en.png" 
            alt="Bottom View Pinout Touch Dot S3" 
            style="width: 90%; height: auto; border: 1px solid #ccc; border-radius: 8px;"
          >
        </a>
      </div>
...
Main Pin Map ESP32-S3 Touch Dot
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. list-table:: Main Pin Map – ESP32-S3 Touch Dot (Simplified)
  :header-rows: 1
  :widths: 33 33 33
