...
Harness the power of WS2812-2020 LED strips with the Touch Dot S3 board. Learn how to control RGB LED strips and create dazzling lighting effects using MicroPython.

This section describes how to control WS2812 LED strips using the Touch Dot S3 board.
The Touch Dot S3 board has a GPIO pin embebbed connected to the single WS2812 LED.
